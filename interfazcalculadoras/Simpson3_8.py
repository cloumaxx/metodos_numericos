...
class Ui_Form(object):
    ...
    def setupUi(self, simpson38):
        ...
        self.label_5 = QtWidgets.QLabel(simpson38)
        self.label_5.setGeometry(QtCore.QRect(130, 60, 251, 31))
        self.label_5.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.label_5.setText("")
        self.label_5.setObjectName("label_5")

        self.labelintegral_2 = QtWidgets.QLabel(simpson38)
        ...
        self.labelvalorintegral = QtWidgets.QLabel(simpson38)
        ...
        self.labelerror = QtWidgets.QLabel(simpson38)
    ...
    def eventCalcular(self):
        try:
            ...
            salida =cal38.calcularError(self.entrada,float(self.entrada2),float(self.entrada3),int(self.entrada4))
    ...
    def retranslateUi(self, simpson38):
        ...
        self.labelintegral_2.setText(_translate("simpson38", "∫_a^b▒f(x)dx"))

...
class Ui_ConversorEntreBases(object):
    ...
    def setupUi(self, ConversorEntreBases):
        ...
        ##################################################################
        self.label = QtWidgets.QLineEdit(ConversorEntreBases)
        self.label.setGeometry(QtCore.QRect(250, 90, 230, 31))
        self.label.setObjectName("label")
        self.label.setStyleSheet(
            "border-radius: 25px;border: 1px solid black;")  ##################################################################################################

        self.label_3 = QtWidgets.QLineEdit(ConversorEntreBases)
        ...
        self.label_4 = QtWidgets.QLineEdit(ConversorEntreBases)
        ...
        self.label_5 = QtWidgets.QLineEdit(ConversorEntreBases)
        ...
        self.label_6 = QtWidgets.QLineEdit(ConversorEntreBases)

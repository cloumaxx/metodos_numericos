...
# Form implementation generated from reading ui file 'Simpson1-3.ui'
#
...
from funciones import calcSimpson13 as simp13
...
class Ui_Form(object):
    ...
    def setupUi(self, Simpson13):
        Simpson13.setObjectName("Simpson13")
        Simpson13.resize(1500, 799)
        Simpson13.setStyleSheet("background-color: rgb(250, 250, 250);")
        Simpson13.setWindowIcon(QtGui.QIcon(resolver_ruta('imagenes/icono.png')))  # se copia y pega esta linea en todas  las interfaces
        ...
        self.textEdit_1 = QtWidgets.QLabel(Simpson13)
        ...
        self.labelintegral = QtWidgets.QLabel(Simpson13)
        ...
        self.labelintegral_2 = QtWidgets.QLabel(Simpson13)
        ...
        self.labelestremoizq = QtWidgets.QLineEdit(Simpson13)
        ...
        self.labelextremodere = QtWidgets.QLineEdit(Simpson13)
        ...
        self.labelIntervalo = QtWidgets.QLabel(Simpson13)
        ...
        self.labelParticiones = QtWidgets.QLineEdit(Simpson13)
        ...
        self.LabeIngreso = QtWidgets.QLabel(Simpson13)
        ...
        self.valorintegral = QtWidgets.QLabel(Simpson13)
        ...
        self.Error = QtWidgets.QLabel(Simpson13)
        ...
        self.Extremodere = QtWidgets.QLabel(Simpson13)
        ...
        self.botonCalcular = QtWidgets.QPushButton(Simpson13)
        ...
        self.labelsalida = QtWidgets.QLabel(Simpson13)
        ...
        self.Funcion = QtWidgets.QLabel(Simpson13)
        ...
        self.Extremoizq = QtWidgets.QLabel(Simpson13)
        ...
        self.particiones = QtWidgets.QLabel(Simpson13)
        ...
        self.botonAC.clicked.connect(self.eventoBorrarTotal)

        self.retranslateUi(Simpson13)
        QtCore.QMetaObject.connectSlotsByName(Simpson13)
    ...
    def eventCalcular(self):
        try:
            try:
                ...
                salida = simp13.calculaError(self.entrada, float(self.entrada2), float(self.entrada3),
                                             int(self.entrada4))
    ...
    def retranslateUi(self, Simpson13):
        ...
        self.Error.setText(_translate("Simpson13", "Error ="))
        self.Extremodere.setText(_translate("Simpson13", "Extremo Der  b ="))
        self.botonCalcular.setText(_translate("Simpson13", "Calcular"))
        self.labelsalida.setText(_translate("Simpson13", "Salida:"))
        self.Funcion.setText(_translate("Simpson13", "Función F(x) ="))
        self.Extremoizq.setText(_translate("Simpson13", "Extremo Izq  a ="))
        self.particiones.setText(_translate("Simpson13", "Numero de Particiones  n ="))
        self.labelintegral.setText(_translate("Simpson13", "Integral :  "))
        self.botonUno.setText(_translate("Simpson13", "1"))
        self.botonUno.setShortcut(_translate("Simpson13", "1"))
        self.botonDos.setText(_translate("Simpson13", "2"))
        self.botonDos.setShortcut(_translate("Simpson13", "2"))
        self.botonTres.setText(_translate("Simpson13", "3"))
        self.botonTres.setShortcut(_translate("Simpson13", "3"))
        self.botonCuatro.setText(_translate("Simpson13", "4"))
        self.botonCuatro.setShortcut(_translate("Simpson13", "4"))
        self.botonCinco.setText(_translate("Simpson13", "5"))
        self.botonCinco.setShortcut(_translate("Simpson13", "5"))
        self.botonSeis.setText(_translate("Simpson13", "6"))
        self.botonSeis.setShortcut(_translate("Simpson13", "6"))
        self.botonSiete.setText(_translate("Simpson13", "7"))
        self.botonSiete.setShortcut(_translate("Simpson13", "7"))
        self.botonOcho.setText(_translate("Simpson13", "8"))
        self.botonOcho.setShortcut(_translate("Simpson13", "8"))
        self.botonNueve.setText(_translate("Simpson13", "9"))
        self.botonNueve.setShortcut(_translate("Simpson13", "9"))
        self.botonCabierto.setText(_translate("Simpson13", "("))
        self.botonCabierto.setShortcut(_translate("Simpson13", "("))
        self.botonCero.setText(_translate("Simpson13", "0"))
        self.botonCero.setShortcut(_translate("Simpson13", "0"))
        self.botonCerrado.setText(_translate("Simpson13", ")"))
        self.botonCerrado.setShortcut(_translate("Simpson13", ")"))
        self.botonCabierto_2.setText(_translate("Simpson13", "["))
        self.botonCabierto_2.setShortcut(_translate("Simpson13", "("))
        self.botonPunto.setText(_translate("Simpson13", "."))
        self.botonPunto.setShortcut(_translate("Simpson13", "."))
        self.botonCabierto_3.setText(_translate("Simpson13", "]"))
        self.botonCabierto_3.setShortcut(_translate("Simpson13", "("))
        self.botonMas.setText(_translate("Simpson13", "+"))
        self.botonMas.setShortcut(_translate("Simpson13", "+"))
        self.botonMas_2.setText(_translate("Simpson13", "√"))
        self.botonMas_2.setShortcut(_translate("Simpson13", "+"))
        self.botonMas_3.setText(_translate("Simpson13", "exp"))
        self.botonMas_3.setShortcut(_translate("Simpson13", "+"))
        self.botonMas_11.setText(_translate("Simpson13", "tan"))
        self.botonMas_11.setShortcut(_translate("Simpson13", "+"))
        self.botonMenos.setText(_translate("Simpson13", "-"))
        self.botonMenos.setShortcut(_translate("Simpson13", "-"))
        self.botonMas_4.setText(_translate("Simpson13", "^"))
        self.botonMas_4.setShortcut(_translate("Simpson13", "+"))
        self.botonMas_8.setText(_translate("Simpson13", "log"))
        self.botonMas_8.setShortcut(_translate("Simpson13", "+"))
        self.botonMas_12.setText(_translate("Simpson13", "sec"))
        self.botonMas_12.setShortcut(_translate("Simpson13", "+"))
        self.BotonMulti.setText(_translate("Simpson13", "*"))
        self.BotonMulti.setShortcut(_translate("Simpson13", "*"))
        self.botonMas_7.setText(_translate("Simpson13", "π"))
        self.botonMas_7.setShortcut(_translate("Simpson13", "+"))
        self.botonMas_9.setText(_translate("Simpson13", "sin"))
        self.botonMas_9.setShortcut(_translate("Simpson13", "+"))
        self.botonMas_13.setText(_translate("Simpson13", "csc"))
        self.botonMas_13.setShortcut(_translate("Simpson13", "+"))
        self.botonDivision.setText(_translate("Simpson13", "÷"))
        self.botonDivision.setShortcut(_translate("Simpson13", "/"))
        self.botonMas_5.setText(_translate("Simpson13", "ln"))
        self.botonMas_5.setShortcut(_translate("Simpson13", "+"))
        self.botonMas_10.setText(_translate("Simpson13", "cos"))
        self.botonMas_10.setShortcut(_translate("Simpson13", "+"))
        self.botonMas_14.setText(_translate("Simpson13", "cot"))
        self.botonMas_14.setShortcut(_translate("Simpson13", "+"))
        self.botonPorcentaje.setText(_translate("Simpson13", "%"))
        self.botonPorcentaje.setShortcut(_translate("Simpson13", "%"))
        self.botonMas_6.setText(_translate("Simpson13", "x"))
        self.botonMas_6.setShortcut(_translate("Simpson13", "+"))
        self.BotonBorrar.setText(_translate("Simpson13", "C"))
        self.BotonBorrar.setShortcut(_translate("Simpson13", "Esc"))
        self.botonAC.setText(_translate("Simpson13", "AC"))
...
if __name__ == "__main__":
    ...
    Simpson13 = QtWidgets.QWidget()
    ui = Ui_Form()
    ui.setupUi(Simpson13)
    Simpson13.show()
    sys.exit(app.exec_())

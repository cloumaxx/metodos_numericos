...
def errorRelativo(r_i, r_i1):
    ...
    return resultado
def returnTabla(funcion,intervaloA,intervaloB,E_t):
    funcion=traductor(funcion)
    listadoIteraciones=[]
    listadoFunciones=[]
    listadoPuntosA=[]
    ...
    if (F_a * F_b) < 0:
        while salir == False:
            ...
            listadoIteraciones.append(iteracion)
            listadoFunciones.append(remplazoFuncion(funcion, 'x'))
            listadoPuntosA.append(a)
            listadoPuntosB.append(b)
            listadoFri.append(F_ri)
            listadoErrorT.append(E_t)
            listadoErrorRi.append(E_r)

            if iteracion >= 50 or E_r < E_t:

                raiz = ri
                listadoRaiz.append(raiz)
                salir = True
            else:
                listadoRaiz.append(" ")
                fila.append(' ')
        ...
        print('no hay raices')
    salida=[]
    salida.append(listadoIteraciones)
    salida.append(listadoFunciones )
    salida.append(listadoPuntosA )
    salida.append(listadoPuntosB )
    salida.append(listadoFri)
    salida.append(listadoErrorT)
    salida.append(listadoErrorRi )
    salida.append(listadoRaiz )
    return salida
